...
suite('Functional Tests', function () {
  ...
  // Browser.site = 'https://ripple-climbing-hook.glitch.me';
  ...
  suite('e2e Testing with Zombie.js', function () {
    ...
    suite('"Famous Italian Explorers" form', function () {
      ...
      // ### EXAMPLE ###
      test('#example - submit the input "surname" : "Polo"', async () => {
      ...
      test('submit "surname" : "Colombo" - write your e2e test...', async () => {
        // fill the form...
      ...
      test('submit "surname" : "Vespucci" - write your e2e test...', async () => {
